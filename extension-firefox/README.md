...
Firefox向け拡張機能は、Firefoxがアクティブな時のショートカット操作用です。
Chrome / Edge向け拡張機能のようなゲーム中のグローバルショートカットには対応していません。
...
FF14をアクティブにしたままショートカットで切り替えたい場合は、Chrome / Edge向け拡張機能を利用してください。
